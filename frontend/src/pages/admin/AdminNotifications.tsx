  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#FAF9F6' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14">
            <div className="flex items-center space-x-4">
              ...
              <span className="font-semibold text-gray-900">Work Notifications</span>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-900 mb-4">Agent Work Summary</h2>
            ...
            <table className="min-w-full">
              <thead>
                <tr className="border-b border-gray-200 bg-gray-50">
                  ...
                  <th className="px-6 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Not Completed</th>
                  ...
                  <tr key={agent.agentId} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${
                        agent.pendingWorks > 0 ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-800'
                      }`}>
                        <svg className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                          <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="border-b border-red-100 bg-red-50">
                    <th className="px-4 py-3 text-left text-xs font-semibold text-red-700 uppercase tracking-wider">Agent</th>
                    ...
                    return (
                      <tr key={work.id} className="hover:bg-red-50 transition-colors">
                        <td className="px-4 py-4">
                          <span className="text-sm font-medium text-gray-900">{work.assignedTo?.name || 'Unknown'}</span>
                        </td>
                        <td className="px-4 py-4">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              <div className="font-medium text-gray-900 text-sm">{work.lead?.name || 'Unknown'}</div>
              ...
              <table className="min-w-full">
                <thead>
                  <tr className="border-b border-green-100 bg-green-50">
                    <th className="px-4 py-3 text-left text-xs font-semibold text-green-700 uppercase tracking-wider">Agent</th>
        ...
        {/* Empty State */}
        {workStats && workStats.pendingWorksList.length === 0 && workStats.recentCompletedWorks.length === 0 && agentSummaries.length === 0 && (
          <div className="bg-white rounded-xl border border-gray-200 p-12 text-center">
            ...
            <p className="mt-2 text-sm text-gray-500">All caught up! No pending works at the moment.</p>
          </div>
        )}
      </main>
    </div>
